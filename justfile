...
# Symuluj learn-agenta w nowej sesji Claude Code (Sonnet 4.6 + SYSTEM_PROMPT + /prime)
metacc:
    claude --model sonnet --append-system-prompt "$(cat prompts/SYSTEM_PROMPT.md)" /prime
